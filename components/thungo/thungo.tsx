        ...
        <>
            ...
            >
                ...
                <div className="relative flex h-full flex-col items-center text-center">
                    ...
                    <div className="group mt-8 grid h-20 w-20 place-items-center rounded-full bg-white/25 backdrop-blur-md transition hover:scale-110">
                        <div className="grid h-16 w-16 place-items-center rounded-full border-4 border-black bg-gradient-to-br from-rose-300 to-pink-500 shadow-xl">
                            <Heart className="h-9 w-9 fill-red-500 text-red-500 transition group-hover:scale-110" />
                        </div>
                    </div>
            ...
            {/* buttons */}
            <div className="mt-[-28px] flex justify-center sm:gap-8 gap-2">
                <button
                    onClick={handleOpen}
                    className="
                        z-40 rounded-full
